...
<header class="dash-header transprent-bg fixed-header">
    @else
    <header class="dash-header">
        ...
        <div class="header-wrapper">
            ...
            <div class="ms-auto header-center">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="dropdown dash-h-item">
                        <a class="message-box me-0 " href="{{ url('chats') }}" aria-haspopup="false"
                            aria-expanded="false">
                            <img src="{{ asset('assets/images/design-images/dashboard/message-text.svg') }}" alt="" class="msg-imh-header">
                            <span class="dash-h-badge message-toggle-msg  message-counter custom_messanger_counter beep"> {{ $unseenCounter }}<span
                                    class="sr-only"></span>
                            </span>
                        </a>
                    </li>
